            ...
            <footer className="site-footer">
                <div className="footer-content">
                    <div className="footer-main">
                        <div className="footer-brand">
                            ...
                            <div className="social-icons">
                                ...
                                <a href="https://wa.me/9197744525892" className="social-link" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="footer-columns">
                                ...
                                <ul className="contact-list">
                                    <li className="contact-item">
                                        ...
                                        <div>
                                            ...
                                            <span className="contact-value">mtechelectro@gmail.com</span>
                                        </div>
                                    </li>
                                    <li className="contact-item">
                                        <svg className="contact-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div className="footer-column">
                                ...
                                <nav className="footer-nav">
                                    ...
                                    <a
                                        href="https://wa.me/919349489349?text=I%20am%20interested%20in%20M%20Tech%20products"
                                        className="nav-link"
                                        target="_blank"
                            ...
                            <div className="footer-column">
                                ...
                                <nav className="footer-nav">
                                    <span className="nav-link-static">LED Bulbs & Lighting</span>
                                    <span className="nav-link-static">Solar Street Lights</span>
                                    <span className="nav-link-static">Solar Power Plants</span>
                                    <span className="nav-link-static">Solar Inverters</span>
                                    <span className="nav-link-static">Solar Water Heaters</span>
                                    <span className="nav-link-static">Solar Cooking System</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-bottom">
                        <p className="copyright">&copy; {new Date().getFullYear()} M Tech Electro Digital Industry. All rights reserved.</p>
                        <p className="footer-tagline">Est. 1991 · Powering Tomorrow with Clean Energy</p>
                    </div>
                </div>
